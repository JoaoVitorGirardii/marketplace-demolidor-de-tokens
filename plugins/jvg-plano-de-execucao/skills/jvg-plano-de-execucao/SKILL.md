...
> "A análise que você passou não tem [X]. Sem isso eu não tenho base para [Y]. Você quer voltar e completar antes (provavelmente rodando a skill `jvg-analise-tecnica`), ou preferia que a gente decida [X] aqui mesmo na conversa?"
...
- **Não investiga código.** Isso é da `jvg-analise-tecnica`. Se chegar aqui sem análise técnica, pare e oriente o usuário a investigar antes.
